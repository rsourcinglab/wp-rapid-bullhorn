...
include_once('WpRapidBullhorn_InstallIndicator.php');


class WpRapidBullhorn_LifeCycle extends WpRapidBullhorn_InstallIndicator {
    ...
    public function addSettingsSubMenuPage() {
        $this->addCornsSubMenuPageToCornsMenu();
    ...
    protected function addSettingsSubMenuPageToSettingsMenu() {
	 ...
	 protected function addCornsSubMenuPageToCornsMenu() {
        $this->requireExtraPluginFiles();
        $displayName = 'Import Bullhorn';
        add_management_page($displayName,
                         $displayName,
                         'manage_options',
                         $this->getSettingsSlug(),
                         array(&$this, 'importBullhornPage'));
    }
